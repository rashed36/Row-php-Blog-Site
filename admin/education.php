...
<!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
        ...
        <div class="header-title">
           ...
           <button  style="margin-left: 90px"  type="button" class="btn btn-success w-md m-b-5" onclick="window.location.href='education.php'">Skill</button>
 		<button  type="button" class="btn btn-success w-md m-b-5" onclick="window.location.href='manage_education.php'">Education</button>
            ...
            <div class="panel panel-bd lobidrag">
                ...
                <div class="panel-body">
                    ...
                    <form action="controller.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div>
                            <button type="submit" name="education_submit" class="btn btn-primary">Submit</button>
