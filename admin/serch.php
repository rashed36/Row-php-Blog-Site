...
<!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
        ...
        <form action="serch.php" method="POST" class="form-inline d-none d-sm-inline">
        <input type="text" name="search" class="form-control " />
         <button class="btn btn-success" name="profile_serch">Srearch</button>
      </form>
...
$search = $_REQUEST['q'];
$qury = mysqli_query("SELECT * FROM profile WHERE Name=$search");
