    ...
    <section class="content-header">
        ...
        <button  type="button" class="btn btn-success w-md m-b-5" onclick="window.location.href='manage_work.php'">Manage -Work</button>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Manage Work-Experience</li>
            </ol>
        </div>
    </section>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $res['WorkNames']; ?></td>
                                <td><?php echo $res['Period']; ?></td>
                                <td><?php echo $res['Projectcomplete']; ?></td>
                                <td><?php echo $res['WorkingHoure']; ?></td>
                                <td>
                                    <a href="all_update.php?work_id=<?php echo $res['id'];?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                    
                                    <a href="delete.php?work_id=<?php echo $res['id'];?>" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                        </tbody>
                        <?php } ?>
